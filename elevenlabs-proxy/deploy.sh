...
wait_for_health() {
  ...
  for _ in $(seq 1 30); do
    ...
    elif $DOCKER exec pclip-elevenlabs-proxy node -e \
  ...
  $DOCKER_COMPOSE logs --tail 30 elevenlabs-proxy 2>/dev/null || true
  return 0
}
...
echo ""
echo "=========================================="
echo "Готово. Прокси слушает :${PORT:-3099}"
echo "=========================================="
